...
//		this.color={cColor:"#000000",bColor:"#FFFFFF",tColor:"#cad9ea",wColor:"#000000"};
		...
		if(this.config.isHaveTitle){
			mainBox += ''+
				'<tr><td id="dialogBoxHeader">'+
					...
					'<td width="6"></td>'+
					'<td id="dialogBoxTitle">'+ this.info.title +'&ensp;</td>'+
		...
		var confirm=''+
			'<div style="width:100%;height:100%;text-align:center;">'+
				...
				'<div style="margin:20px;">'+
					'<input type="button" id="dialogOk" class="button1" value=" 确定 "/>&ensp;'+
		...
		$('.caClass,#refMode,object,embed').css("visibility","hidden");
		try {
			$id('marInfo').stop();
		}catch (e) {}
		try {
		...
		$('.caClass,#refMode,object,embed').css("visibility","visible");
		try {
			$id('marInfo').start();
		}catch (e) {}
		try {
